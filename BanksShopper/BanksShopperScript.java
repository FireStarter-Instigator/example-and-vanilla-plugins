...
public class BanksShopperScript extends Script {
    ...
    WorldPoint faladorShopPoint = new WorldPoint(2957, 3387, 0);
            ...
            try {
                ...
                switch (state) {
                    case SHOPPING:
                        ...
                        /// / how to prevent triggering this even further
                        /// / this is suppose to be a walking feature so that when finished trading they shop, but may not be needed
                        /*if (!Rs2Shop.isOpen() && Rs2Player.getWorldLocation().distanceTo(faladorShopPoint) > 9 && !Rs2Player.isMoving()) {
                            Rs2Walker.walkTo(faladorShopPoint);
                        }*/
    ...
    private void hopWorld() {
        ...
        if (plugin.isUseNextWorld()) {Rs2Shop.closeShop();
